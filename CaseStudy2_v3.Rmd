...
graph1 + geom_point(mapping = aes(x=EnvirSatisf, y=MonthlyInc, color=Attrition)) +xlab("Environment Satisfaction") + ylab("MonthlyIncome") + ggtitle ("Relationship Between Environment and Monthly Income") + geom_smooth(method = "lm", mapping = aes(x=EnvirSatisf, y=MonthlyInc))
